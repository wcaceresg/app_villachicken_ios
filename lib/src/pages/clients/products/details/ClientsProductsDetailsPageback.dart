...
class _ClientsProductDetailPageState extends State<ClientsProductDetailPage> {
                                  ...
                                  // Divider(),
                                   ...
                                   (
                                      ...
                                      child: RadioListTile<String>
                                        ...
                                        title:Text(_con.selectedProducts[0]["relationships"]["detalles"][index]["relationships"]["combinaciones"][index2]["attributes"]["producto"]) ,
                                        onChanged: (val){
                                          //print(val);
                                          setState(() { 
  ...
  Widget _ImagePaquete(){
    return FlexibleSpaceBar(
              background: _con.selectedProducts.length>0 ?  
                             Image.network
