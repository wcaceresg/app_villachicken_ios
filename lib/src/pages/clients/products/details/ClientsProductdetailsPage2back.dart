...
class _ClientsProductDetailPageState extends State<ClientsProductDetailPage> {
  List<bool> _selectedExtras = List<bool>.filled(5, false); // 5 items
            ...
            Container(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: Text('Agrega adicionales a tu pedido'),
                  children: [
                    _buildCheckBoxTile(0, 'Chorizo artesanal', 10.90),
                    _buildCheckBoxTile(1, 'Palo de anticucho', 10.90),
                    _buildCheckBoxTile(2, 'Morcilla', 10.90),
                    _buildCheckBoxTile(3, 'Brocheta de pollo', 10.90),
                    _buildCheckBoxTile(4, 'Mollejitas', 10.90),
                  ],
                ),
              ),
            ),
    ...
    return Container(
                ...
                //child: Center(child:  BigText(text: _con.NombrePaquete,size: 21,),),
                 child: Center(
                  child: Column(
                    children: [
                      BigText(text: _con.NombrePaquete,size: 21,),
                      SizedBox(height: 10,),
                      Container(
  ...
  Widget _buildCheckBoxTile(int index, String title, double price) {
    return SizedBox(
      //height: 40,
      child: Padding(
